"""
Title: Minimum Operations to Exceed Threshold Value
...
Approach:
- use min heap and follow instructions
...
class Solution:
    def minOperations(self, nums: List[int], k: int) -> int:
        ...
        while len(min_heap) >= 2 and min_heap[0] < k:
            ...
            z = min(x, y) * 2 + max(x, y) # or since we know that x is smaller cuz heap, we can just do 2 * x + y
